...
package test.domain.persistence.df;
 ...
 *
 */
public class PersistenceDFTesterAgent extends TesterAgent {
	// keys for group arguments
	public static final String DB_URL_KEY = "db-url";
	public static final String DB_DRIVER_KEY = "db-driver";
	
	protected TestGroup getTestGroup() {
		TestGroup tg = new TestGroup("test/domain/persistence/df/persistenceDFTestsList.xml");		
	...
	public static void main(String[] args) {
      ...
      AgentController tester = mc.createNewAgent("tester", "test.domain.persistence.df.PersistenceDFTesterAgent", args);
      tester.start();
		}
		catch (Exception e) {
			e.printStackTrace();
