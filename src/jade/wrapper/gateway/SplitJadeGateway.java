...
public class SplitJadeGateway extends DynamicJadeGateway {
	...
	public void checkJADE() throws StaleProxyException, ControllerException {
		...
		MicroRuntime.startJADE(profile.getProperties(), new Runnable() {
			public void run() {
				...
				myLogger.log(Logger.INFO,"Exiting now!");
				System.exit(0);
			} 
		});
		if (MicroRuntime.isRunning()) {
			myLogger.log(Logger.INFO, "JADE running");
		}
		else {
			myLogger.log(Logger.WARNING, "JADE connection error");
			shutdown();
		}
