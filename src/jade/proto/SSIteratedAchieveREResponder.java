...
public class SSIteratedAchieveREResponder extends SSResponder {
	...
	public SSIteratedAchieveREResponder(Agent a, ACLMessage request, DataStore store) {
		...
		registerTransition(RECEIVE_NEXT, HANDLE_REQUEST, ACLMessage.REQUEST, new String[]{HANDLE_REQUEST, SEND_REPLY, RECEIVE_NEXT}); 
		registerTransition(RECEIVE_NEXT, HANDLE_CANCEL, ACLMessage.CANCEL); 
		registerTransition(RECEIVE_NEXT, HANDLE_CANCEL, MsgReceiver.TIMEOUT_EXPIRED); 
		registerDefaultTransition(HANDLE_REQUEST, DUMMY_FINAL);
