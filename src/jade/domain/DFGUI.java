...
//   }//add(Component)
  ...
  public DFGUI() {
    ...
    menu1.addSeparator();
    miExit = new JMenuItem("Shutdown the DF Agent");
    menu1.add(miExit);
  ...
  JMenu menu1, menu3;
  JMenuItem miView, miRegister, miModify, miDeregister, miRegisterDF, miExit, miAbout;
  //}}
...
class AboutDialog extends JDialog {
  ...
  public AboutDialog(JFrame parent, boolean modal) {
    ...
    add(okButton);
    textArea1 = new JTextArea("This is a FIPA97-compliant Directory Facilitator. It provides a yellow-page service to a multi-agent system. This GUI allows to manage this DF agent.",10,10);
  ...
  public AboutDialog(JFrame parent, String title, boolean modal) {
    this(parent, modal);
    setTitle(title);
  }//Constructor(JFrame, String, boolean)
