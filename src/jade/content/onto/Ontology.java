...
public class Ontology {
     ...
     *
     */
    public void addElement(ObjectSchema schema) throws OntologyException {
        addElement(schema, null);
    } 
     ...
     *
     */
    public void addElement(ObjectSchema schema, 
     ...
     *
     */
    public ObjectSchema getElementSchema(String name) 
            throws OntologyException {
        if (name == null) {
        ...
        if (ret == null) {
            if (base != null) {
                return base.getElementSchema(name);
            } 
     ...
     *
     */
    public ObjectSchema getElementSchema(Class javaClass) 
            throws OntologyException {
        if (javaClass == null) {
            throw new OntologyException("Null schema identifier");
        } 
        ...
        if (ret == null) {
            if (base != null) {
                return base.getElementSchema(javaClass);
            } 
     ...
     *
     */
    public Class getElementClass(String name) throws OntologyException {
        if (name == null) {
            throw new OntologyException("Null schema identifier");
        } 
        ...
        if (ret == null) {
            if (base != null) {
                return base.getElementClass(name);
            } 
