...
/**
	Abstract interface for application defined ontology.<br>
	<br>
  ...
  Each ontological role is characterised by a <b>name</b> and a structure
	...
	can be represented as <code>Frame</code> instances or as instances of  
	user-defined Java classes, each one representing a role.<br>
	The methods in the <code>Ontology</code> interface allows to manage ontological 
  roles and to conveniently handle instances of these roles in both ways.<br>
...
public interface Ontology {
  ...
  */
  ...
  /**
     Constant for category of slots whose value is a <code>primitive</code> entity
     @see jade.onto.SlotDescriptor
     @see jade.onto.Frame
  */
  ...
  */
  ...
  /**
    Adds a role to the ontology, defined by the structure
    of all its slots.
  ...
  */
  ...
  /**
    ...
    create user defined Java objects representing instances of the role that
    is being added.
 */
  ...
  */
  ...
  /** 
  	@return the roleName of the role represented by the passed class as 
