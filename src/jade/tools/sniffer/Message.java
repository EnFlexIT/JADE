...
public class Message extends jade.lang.acl.ACLMessage implements Serializable{
  ...
  public static final int step = 80;
	...
	public Message(String s, String r){
	  ...
	  super(ACLMessage.INFORM);  
		...
		this.setSender(new AID(s));
		this.addReceiver(new AID(r));
	}
  ...
  public Message(ACLMessage msg) {
    ...
    Properties up = msg.getAllUserDefinedParameters();
    for (Enumeration e=up.propertyNames(); e.hasMoreElements(); ) {
      String key = (String)e.nextElement();
      this.addUserDefinedParameter(key,up.getProperty(key));
    }
  }
