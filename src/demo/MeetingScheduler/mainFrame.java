...
public mainFrame(MeetingSchedulerAgent a, String title) {
 ...
 public mainFrame()
	...
	static public void main(String args[])
	{
	  ...
	  f.setVisible(false);
	  (new PasswordDialog(f, "Enter your name and password")).setVisible(true);
	...
	void miViewDF_Action(java.awt.event.ActionEvent event)
	{
        ...
        while (e.hasMoreElements()) {
            listNames.addItem((String)e.nextElement());
        }
	...
	{ // Remove an appointment
		...
		//{{CONNECTION
		myAgent.cancelAppointment(new Date(calendar1.getDate()));
		calendar1_Action(null);
		//}}
	}
	...
	void textFieldDFaddress_EnterHit(java.awt.event.ActionEvent event)
	{
		...
		myAgent.DFregistration(textFieldDFaddress.getText());
		//}}
	}
