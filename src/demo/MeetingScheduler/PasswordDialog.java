...
public class PasswordDialog extends Frame // ModalDialog
{
  ...
  public PasswordDialog(MeetingSchedulerAgent a, String aName, String title) {
    this((Frame)null,aName,title);
    myAgent=a;
  }
  
  public PasswordDialog(Frame parent, String aName, String title) {
	  //		super(parent, title);
	...
	{
		this(parent, "aaa", "Username/Password");
	}
