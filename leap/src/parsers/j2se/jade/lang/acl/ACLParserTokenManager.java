...
static final int[] jjnextStates = {
   21, 39, 40, 41, 43, 11, 44, 45, 39, 11, 44, 49, 3, 4, 6, 3, 
   4, 8, 6, 40, 41, 43, 11, 5, 7, 9, 14, 15, 46, 47, 125, 138, 
   144, 155, 170, 113, 120, 95, 99, 106, 73, 81, 89, 61, 63, 68, 53, 56, 
};
...
public ACLParserTokenManager(ASCII_CharStream stream)
{
   if (ASCII_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ACLParserTokenManager(ASCII_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
