...
public class ACLParser implements ACLParserConstants {
 ...
 AID cur = new AID();
    ...
    while (true) {
      ...
      case NAME:
        ...
        t = jj_consume_token(WORD);
                       cur.setName(t.image); token_source.SwitchTo(AIDSTATE);
        break;
      case ADDRESSES:
 ...
 {if (true) return cur;}
  ...
  final private int[] jj_la1_0 = {0xfff8000,0x0,0x0,0xfff8000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
  final private int[] jj_la1_1 = {0x0,0x800000,0x800000,0x0,0x10c,0x4,0x800000,0x3c0000,0x3c0000,0x5fe,0x5fe,0x108,0xf0,0xc0,};
