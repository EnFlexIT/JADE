    ...
    private class IOEventServer implements PDPContextManager, PDPContextManager.Listener, JICPMediatorManager {
        ...
        public void init(String id, Profile p) {
            ...
            try {
                ...
                myLogger.severe("unable to use " + protoManagerClass + ", fallback to default " + NIOJICPPeer.class.getName());
                /* Use JICP as default
                 *
                 * FIXME or do we want to throw an exception? This way a typo will start your service anyway
                 * and give client possibly unwanted access to your platform
                 */

                pm = new NIOJICPPeer();
            }
            myLogger.info("using " + pm.getClass().getName() + " for protocolmanager");
