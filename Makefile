...
batch: $(CLSDIR) $(DOCDIR)
	...
	echo 'cd ..' >> $(BATCH_DIST)
	echo '$(ZIP) $(ZIPFLAGS) $(PACKAGE)-src-$(VERSION).$(ZIPEXT) $(subst /,\,$(COMMON_FILES)) jade\*.bat jade\Makefile jade\src\Makefile jade\src\*.idl jade\src\FIPA jade\src\jade jade\src\starlight jade\src\*.html jade\classes\*.mf jade\classes\Notice.txt jade\lib\Makefile jade\lib\modules\README' >> $(BATCH_DIST)
